  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8 min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
        ...
        <div className="mt-4 flex md:mt-0 md:ml-4">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-l-md border ${
              activeTab === 'list' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'
            }`}
          >
            My Claims
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-r-md border ${
              activeTab === 'new' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700'
            }`}
          >
            File New Claim
          </button>
      ...
      {activeTab === 'list' ? (
        <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
           <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              ...
              {claims.length === 0 && (
                <tr>
                    <td colSpan="5" className="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">No claims found.</td>
                </tr>
              )}
            </tbody>
          </table>
        ...
        <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg max-w-2xl mx-auto">
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Submit an Insurance Claim</h3>
            <form className="mt-5 space-y-6" onSubmit={handleSubmit}>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Select Policy</label>
                <select
                  required
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    type="number"
                    required
                    className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md"
                    placeholder="0.00"
                    value={amount}
              ...
              <div>
                ...
                <input
                  type="text"
                  required
                  className="mt-1 sticky block w-full shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md"
                  value={reason}
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="shadow-sm focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full sm:text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md"
                  value={description}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Supporting Document (Image/PDF)</label>
                <input
                  type="file"
                  accept="image/*,.pdf"
